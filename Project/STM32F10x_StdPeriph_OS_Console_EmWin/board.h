...
#define BOARD_TYPE  (TEST_BOARD_V1)
	...
	#define _BUTTON_SWITCH_PIN        GPIO_Pin_10
	...
	#define _MAX6675_SO_PIN           GPIO_Pin_12
	
	#define _MAT_LOW_GPIO             GPIOE
	#define _MAT_LOW_PIN              GPIO_Pin_0
